...
public class Tabs
{
public static final ItemGroup ITEMS = createTab("starlight_items", () -> Items.BROWN_DYE);
	
	public static final ItemGroup ARMORS = createTab("starlight_armors", () -> Items.DIAMOND_CHESTPLATE);
